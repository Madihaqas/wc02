...
\begin{parts}
  ...
  \part How many different nonograms can be made from a $5\times5$ grid without any clues? Please explain your answer (Explaination shouldn't be too long. 1-2 line(s) is sufficient enough.
  \begin{solution}
    % Enter your solution here.
  \end{solution}

  \part How many different nonograms can be made from a $5\times5$ grid with clues? Please explain your answer (Explaination shouldn't be too long. 1-2 line(s) is sufficient enough.
  \begin{solution}
    % Enter your solution here.
  \end{solution}
\end{parts}
